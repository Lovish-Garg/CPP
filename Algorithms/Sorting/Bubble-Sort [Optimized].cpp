...
void bubble_sort(int arr[], int n)
{
    ...
    {
        bool swaps = false;// if this will be false after end of J loop it means that the array is already sorted
        ...
        // this condition will break the loop if it finds that array is already sorted
        if (swaps == false)
            break;
    }
}
