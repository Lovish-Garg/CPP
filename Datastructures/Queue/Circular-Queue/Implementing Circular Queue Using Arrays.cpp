// Implementing Circular-queues. This can only be implemented with arrays because with Linked-lists we don't have to worry about space
#include <iostream>
...
class Queue
{
    ...
    public:
        ...
        void enqueue(int data)
        {
            ...
            // else pre-incremnent rear and then modulo with max
            // this is key for the circular-enqueue
            arr[++rear % max] = data;
        }
